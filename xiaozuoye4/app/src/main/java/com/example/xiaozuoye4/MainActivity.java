package com.example.xiaozuoye4;
...
public class MainActivity extends AppCompatActivity {
    ...
    private final static String SharedPreferencesFileName="xinxi";
    //学号
    ...
    public void write(View view) {
        editor.putString(Key_number,"2018011193");
        editor.putString(Key_name,"刘宇轩");
